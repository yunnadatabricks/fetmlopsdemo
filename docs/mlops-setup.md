...
[ML Config](../fetmlopsdemo/terraform/README.md) guides to make changes to ML code or deployed jobs.
...
```
git add README.md docs .gitignore .mlops-setup-scripts fetmlopsdemo/terraform/README.md
...
We recommend including all files outside of `fetmlopsdemo/terraform` in this PR:
...
Follow the instructions in [fetmlopsdemo/terraform/README.md](../fetmlopsdemo/terraform/README.md) to deploy ML resources
and production jobs.
...
[ML pull request guide](ml-pull-request.md) and [ML resource config guide](../fetmlopsdemo/terraform/README.md) to propose, test, and deploy
